 ...
 */
final class Version20240611182816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_properties (id INT AUTO_INCREMENT NOT NULL, gender_id INT NOT NULL, name VARCHAR(50) NOT NULL, INDEX IDX_D866B5FA708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE player_properties ADD CONSTRAINT FK_D866B5FA708A0E0 FOREIGN KEY (gender_id) REFERENCES genders (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player_properties DROP FOREIGN KEY FK_D866B5FA708A0E0');
